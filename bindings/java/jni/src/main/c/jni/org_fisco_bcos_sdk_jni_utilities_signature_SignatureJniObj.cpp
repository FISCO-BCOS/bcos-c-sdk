    ...
    JNIEnv* env, jclass, jlong jkeypair, jstring jtx_data_hash, jstring jhsm_lib_path)
{
    ...
    struct bcos_sdk_c_signature_result sign_result =
        bcos_sdk_sign(keypair, tx_data_hash, hsm_lib_path);
    ...
    jstring jsigned_data, jstring jhsm_lib_path)
{
    ...
    bool is_verify_success = bcos_sdk_verify(crypto_type, (void*)public_key, pubkey_len,
        tx_data_hash, (void*)signed_data, signed_data_len, hsm_lib_path);
