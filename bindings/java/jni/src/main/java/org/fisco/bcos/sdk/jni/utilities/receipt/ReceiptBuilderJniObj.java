...
public class ReceiptBuilderJniObj {
    ...
    public static native long createReceiptData(
            String gasUsed, String contractAddress, String output, long blockNumber)
            throws JniException;

    /**
     * Create a Receipt Data object with json
     *
     * @param json version: number gasUsed: string contractAddress: string status: number output:
     *     hex string logEntries: array<LogEntry> blockNumber: number logEntry: address: string
     *     topic: array<hex string> data: hex string
     * @return Receipt Data pointer
     */
     ...
     */
    public static native String decodeReceiptDataToJsonObj(String ReceiptDataHex)
            throws JniException;
