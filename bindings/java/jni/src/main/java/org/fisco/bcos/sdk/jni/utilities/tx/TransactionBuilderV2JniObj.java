...
public class TransactionBuilderV2JniObj {
   ...
   * @param data encoded contract method and params
   * @param abi contract abi, only create contract need
   * @param blockLimit block limit
   * @param value transfer value
   * @param gasPrice gas price
   * @param gasLimit gas limit
   * @return void* transaction data pointer, you should release it after use, check `destroyTransactionData`
   */
  public static native long createTransactionData(
      String groupID, String chainID, String to, String input, String abi, long blockLimit, String value, String gasPrice, long gasLimit)
      throws JniException;
  ...
  public static native long createEIP1559TransactionData(
      String groupID, String chainID, String to, String input, String abi, long blockLimit, String value, long gasLimit, String maxFeePerGas, String maxPriorityFeePerGas)
      throws JniException;
  ...
  public static native String calcTransactionDataHashWithFullFields(
      int cryptoType, TransactionVersion version, String groupID, String chainID, String to, String nonce, String input, String abi, long blockLimit, String value,
      String gasPrice, long gasLimit, String maxFeePerGas, String maxPriorityFeePerGas)
      throws JniException;
   ...
   */
  public static native String calcTransactionDataHashWithJson(int cryptoType, String json) throws JniException;
   ...
   */
  public static native String createSignedTransactionWithSignature(String signature, String txDataHash, TransactionVersion version,
      String groupID, String chainID, String to, String nonce, String input, String abi, long blockLimit, String value,
      String gasPrice, long gasLimit, String maxFeePerGas, String maxPriorityFeePerGas, int attribute, String extraData)
      throws JniException;
  ...
  public static native TxPair createSignedTransactionWithFullFields(
      long keyPair, String groupID, String chainID, String to, String input, String abi, long blockLimit, String value,
      String gasPrice, long gasLimit, int attribute, String extraData)
      throws JniException;
  ...
  public static native TxPair createSignedEIP1559TransactionWithFullFields(
      long keyPair, String groupID, String chainID, String to, String input, String abi, long blockLimit, String value,
      String maxFeePerGas, String maxPriorityFeePerGas, long gasLimit, int attribute, String extraData)
      throws JniException;
}
