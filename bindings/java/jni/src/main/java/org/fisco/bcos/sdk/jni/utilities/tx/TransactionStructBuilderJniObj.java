...
public class TransactionStructBuilderJniObj {
     ...
     */
    public static native String calcTransactionDataStructHash(
            int cryptoType, TransactionData transactionData) throws JniException;
     ...
     */
    public static native String encodeTransactionStruct(Transaction transaction)
            throws JniException;
     ...
     */
    public static native String encodeTransactionStructToJson(Transaction transaction)
            throws JniException;
