...
public class Utility {
    ...
    public static void main(String[] args) throws JniException {
        ...
        long transactionDataWithJson =
                TransactionBuilderJniObj.createTransactionDataWithJson(rawJson);
        ...
        String jsonObj =
                TransactionBuilderJniObj.decodeTransactionDataToJsonObj(encodeTransactionData);
        long transactionDataWithJson1 =
                TransactionBuilderJniObj.createTransactionDataWithJson(jsonObj);
        String hash2 =
                TransactionBuilderJniObj.calcTransactionDataHash(0, transactionDataWithJson1);
        if (!Objects.equals(
