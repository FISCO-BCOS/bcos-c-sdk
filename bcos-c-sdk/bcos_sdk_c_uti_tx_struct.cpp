    ...
    const bcos_sdk_c_transaction_data_v1* tx_data_src)
{
    ...
    try
    {
        ...
        transaction_data_struct_v1->version = tx_data_src->version;
        transaction_data_struct_v1->block_limit = tx_data_src->block_limit;
        transaction_data_struct_v1->chain_id = my_strdup(tx_data_src->chain_id);
        transaction_data_struct_v1->group_id = my_strdup(tx_data_src->group_id);
        transaction_data_struct_v1->nonce = my_strdup(tx_data_src->nonce);
        transaction_data_struct_v1->to = my_strdup(tx_data_src->to);
        transaction_data_struct_v1->abi = my_strdup(tx_data_src->abi);
        transaction_data_struct_v1->input = bytes_struct_copy(tx_data_src->input);
    ...
    bcostars::TransactionDataUniquePtr tars_transaction_data)
{
    ...
    try
    {
        ...
        transaction_data_struct_v1->input = input_bytes;
        transaction_data_struct_v1->version = tars_transaction_data->version;
        transaction_data_struct_v1->block_limit = tars_transaction_data->blockLimit;
        transaction_data_struct_v1->chain_id = my_strdup(tars_transaction_data->chainID.data());
        transaction_data_struct_v1->group_id = my_strdup(tars_transaction_data->groupID.data());
        transaction_data_struct_v1->nonce = my_strdup(tars_transaction_data->nonce.data());
        transaction_data_struct_v1->to = my_strdup(tars_transaction_data->to.data());
        transaction_data_struct_v1->abi = my_strdup(tars_transaction_data->abi.data());
    ...
    struct bcos_sdk_c_transaction_data_v1* transaction_data)
{
    ...
    try
    {
        ...
        tars_transaction_data_v1->input.reserve(transaction_data->input->length);
        for (size_t i = 0; i < transaction_data->input->length; ++i)
        {
            tars_transaction_data_v1->input.push_back(
                static_cast<tars::Char>(transaction_data->input->buffer[i]));
        }
        tars_transaction_data_v1->version = (tars::Int32)transaction_data->version;
        tars_transaction_data_v1->blockLimit = (tars::Int64)transaction_data->block_limit;
        tars_transaction_data_v1->chainID = std::string(transaction_data->chain_id);
        tars_transaction_data_v1->groupID = std::string(transaction_data->group_id);
        tars_transaction_data_v1->nonce = std::string(transaction_data->nonce);
        tars_transaction_data_v1->to = std::string(transaction_data->to);
        tars_transaction_data_v1->abi = std::string(transaction_data->abi);
    ...
    const char* max_fee_per_gas, const char* max_priority_fee_per_gas)
{
    ...
    try
    {
        ...
        transaction_data_struct_v1->version = 1;
        transaction_data_struct_v1->block_limit = block_limit;
        transaction_data_struct_v1->group_id = my_strdup(group_id);
        transaction_data_struct_v1->chain_id = my_strdup(chain_id);
        transaction_data_struct_v1->to = to ? my_strdup(to) : my_strdup("");
        transaction_data_struct_v1->abi = abi ? my_strdup(abi) : my_strdup("");
        transaction_data_struct_v1->nonce = my_strdup(nonceStr.data());
        transaction_data_struct_v1->input =
            create_bytes_struct(bytesInput->size(), reinterpret_cast<char*>(bytesInput->data()));
    ...
    const char* max_priority_fee_per_gas)
{
    ...
    try
    {
        ...
        transaction_data_struct_v1->abi = abi ? my_strdup(abi) : my_strdup("");
        transaction_data_struct_v1->nonce = my_strdup(nonceStr.data());
        transaction_data_struct_v1->input = create_bytes_struct(
            bytes_input_length, const_cast<char*>(reinterpret_cast<const char*>(bytes_input)));
        transaction_data_struct_v1->value = my_strdup(value);
        transaction_data_struct_v1->gas_price = my_strdup(gas_price);
        transaction_data_struct_v1->gas_limit = gas_limit;
    ...
    struct bcos_sdk_c_transaction_data_v1* transaction_data)
{
    ...
    try
    {
        ...
        auto json_str = tars_transaction_data_v1->writeToJsonString();
        return strdup(json_str.c_str());
    }
    catch (const std::exception& e)
    {
    ...
    struct bcos_sdk_c_transaction_v1* transaction)
{
    ...
    {
        auto tars_transaction_v1 = convert_transaction_to_tars_v1(transaction);
        auto json_str = tars_transaction_v1->writeToJsonString();
        return strdup(json_str.c_str());
    }
    catch (const std::exception& e)
    {
